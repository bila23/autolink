...
@NamedQueries({
    ...
    @NamedQuery(name = "Modelo.findByIdmarca", query = "SELECT m FROM Modelo m WHERE m.idmarca = :idmarca"),
    @NamedQuery(name = "Modelo.findByUsuariocrea", query = "SELECT m FROM Modelo m WHERE m.usuariocrea = :usuariocrea"),
